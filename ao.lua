...
if endgg then
    ...
    lapseBlueMax.Anchored = true
    lapseBlueMax.CanCollide = false
    lapseBlueMax.Massless = true
    lapseBlueMax.Parent = game.Workspace

    -- 위치 설정 및 플레이어 따라가기
    lapseBlueMax.CFrame = rootPart.CFrame * CFrame.new(0, 0, 0)
    ...
    task.spawn(function()
        while stillAlive do
            ...
            lapseBlueMax.CFrame = rootPart.CFrame * CFrame.new(0, 7, -15.5)
        end
    end)
